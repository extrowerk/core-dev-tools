...
static irix_compat_t elf32_mips_irix_compat
  (bfd *);
static qnx_compat_t elf32_mips_qnx_compat
  (bfd *);

extern const bfd_target bfd_elf32_bigmips_vec;
extern const bfd_target bfd_elf32_littlemips_vec;

extern const bfd_target bfd_elf32_qnxbigmips_vec;
extern const bfd_target bfd_elf32_qnxlittlemips_vec;
...
#define QNX_COMPAT(abfd) \
  (elf32_mips_qnx_compat (abfd) != qct_none)
...

/* Depending on the target vector we generate some version of QNX 
   executables or "normal" MIPS ELF ABI executables.  */
static qnx_compat_t
elf32_mips_qnx_compat (bfd *abfd)
{
  if ((abfd->xvec == &bfd_elf32_qnxbigmips_vec)
      || (abfd->xvec == &bfd_elf32_qnxlittlemips_vec))
    return qct_qnx6;
  else
    return qct_none;
}
...
#define elf_backend_mips_qnx_compat	elf32_mips_qnx_compat
...
#define TARGET_LITTLE_SYM               bfd_elf32_qnxlittlemips_vec
#define TARGET_LITTLE_NAME              "elf32-qnxlittlemips"
#define TARGET_BIG_SYM                  bfd_elf32_qnxbigmips_vec
#define TARGET_BIG_NAME                 "elf32-qnxbigmips"

#define ELF_MAXPAGESIZE                       0x1000
#define elf32_bed                     elf32_qnxbed

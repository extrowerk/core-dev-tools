     ...
     int *used_at;
{
  ...
  if (mips_pic == NO_PIC)
	...
	off = 0;
      ...
      macro_build ((char *) NULL, counter, (expressionS *) NULL,
		   dbl ? "daddu" : "addu", "d,v,t", reg, reg, GOT_REG);
  ...
  switch (mask)
      ...
      else
	{
	  ...
	  macro_build ((char *) NULL, &icnt, (expressionS *) NULL,
		       dbl ? "ddiv" : "div", "z,s,t", sreg, treg);
          if (mips_arch == CPU_R7900)
	    macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "break", "B", 7);
          else
	    macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "break", "c", 7);
	}
      expr1.X_add_number = -1;
      ...
      else
	{
	  ...
	  --mips_opts.noreorder;
          ...
          if (mips_arch == CPU_R7900)
  	    macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "break", "B", 6);
          else
  	    macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "break", "c", 6);
	}
      ...
      else if ((mips_pic == SVR4_PIC || mips_pic == QNX_PIC) && ! mips_big_got)
	{
	  ...
	  macro_build ((char *) NULL, &icnt, &offset_expr,
		       HAVE_32BIT_ADDRESSES ? "lw" : "ld",
		       "t,o(b)", tempreg, lw_reloc_type, GOT_REG);
	  ...
	  if (! HAVE_NEWABI)
	      ...
	      else
		{
		  ...
		  macro_build ((char *) NULL, &icnt, &expr1,
			       ...
			       GOT_REG, (int) BFD_RELOC_LO16, mips_frame_reg);
		}
	    }
	}
      else
	  ...
	  if (! mips_big_got)
	    {
	      ...
	      if(NOP_NEEDED)
	        macro_build ((char *) NULL, &icnt, (expressionS *) NULL,
			     "nop", "");
	      p = frag_var (rs_machine_dependent, 4, 0,
			    RELAX_ENCODE (0, 4, NOP_NEEDED ? -8 : -4, 0, 0, 0),
			    offset_expr.X_add_symbol, 0, NULL);
	    }
	  else
	    {
      ...
      else if ((mips_pic == SVR4_PIC || mips_pic == QNX_PIC) && ! mips_big_got)
	{
	  ...
	  (void) frag_var (rs_machine_dependent, 0, 0,
			   RELAX_ENCODE (0, 0, NOP_NEEDED ? (-16 - off) : (-12 - off), -8, 1, 0),
			   offset_expr.X_add_symbol, 0, NULL);
	}
      else if ((mips_pic == SVR4_PIC) || (mips_pic == QNX_PIC))
	{
     ...
     struct mips_cl_insn *ip;
{
  ...
  switch (mask)
      ...
      else
	{
	  ...
	  macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "nop", "", 0);
          if (mips_arch == CPU_R7900)
	    macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "break", "B", 6);
          else
	    macro_build ((char *) NULL, &icnt, (expressionS *) NULL, "break", "c", 6);
...
#define OPTION_M7900 (OPTION_MD_BASE + 32)
  {"m7900", no_argument, NULL, OPTION_M7900},
#define OPTION_NO_M7900 (OPTION_MD_BASE + 33)
  {"no-m7900", no_argument, NULL, OPTION_NO_M7900},
#define OPTION_GP64 (OPTION_MD_BASE + 34)
...
#define OPTION_QNX_PIC      (OPTION_ELF_BASE + 7)
  ...
  if (mips_pic == NO_PIC)
      ...
      if (symsec != segtype && ! S_IS_LOCAL (sym))
	{
      ...
      change = (symsec != &bfd_und_section
		...
		&& ((mips_pic != QNX_PIC) || ((mips_pic == QNX_PIC) && !S_IS_EXTERN(sym) && !S_IS_WEAK(sym)))
...
static const struct mips_cpu_info mips_cpu_info_table[] =
{
  ...
  /* Toshiba TX79 */
  { "mips64tx79",     0,      ISA_MIPS3,     CPU_R7900, },
  { "tx79",           0,      ISA_MIPS3,     CPU_R7900, },
  { "7900",           0,      ISA_MIPS3,     CPU_R7900, },
  { "R7900",          0,      ISA_MIPS3,     CPU_R7900, },

...
static long extract_spr
  PARAMS ((unsigned long, int, int *));
static unsigned long insert_sprg 
  PARAMS ((unsigned long, long, int, const char **));
static long extract_sprg
  PARAMS ((unsigned long, int, int *));
...
{ "mtsprg4", XSPR(31,467,276), XSPR_MASK,    PPC405|BOOKE, { RT } },
{ "mtsprg5", XSPR(31,467,277), XSPR_MASK,    PPC405|BOOKE, { RT } },
{ "mtsprg6", XSPR(31,467,278), XSPR_MASK,    PPC405|BOOKE, { RT } },
{ "mtsprg7", XSPR(31,467,279), XSPR_MASK,    PPC405|BOOKE, { RT } },

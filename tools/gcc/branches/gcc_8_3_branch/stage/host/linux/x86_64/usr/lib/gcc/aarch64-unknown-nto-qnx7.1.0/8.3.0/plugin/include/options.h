...
enum opt_code
{
  ...
  OPT_mlittle_endian = 1199,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1200,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1201,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1202,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1203,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1204,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1205,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1206,          /* -msign-return-address= */
  OPT_mstrict_align = 1207,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1208,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1209,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1210,                     /* -mtls-size= */
  OPT_mtune_ = 1211,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1212,             /* -mverbose-cost-dump */
  OPT_n = 1213,                              /* -n */
  OPT_no_canonical_prefixes = 1214,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1215,              /* -no-integrated-cpp */
  OPT_no_pie = 1216,                         /* -no-pie */
  OPT_nocpp = 1217,                          /* -nocpp */
  OPT_nodefaultlibs = 1218,                  /* -nodefaultlibs */
  /* OPT_nopie = 1219, */                    /* -nopie */
  OPT_nostartfiles = 1220,                   /* -nostartfiles */
  OPT_nostdinc = 1221,                       /* -nostdinc */
  OPT_nostdinc__ = 1222,                     /* -nostdinc++ */
  OPT_nostdlib = 1223,                       /* -nostdlib */
  OPT_o = 1224,                              /* -o */
  OPT_p = 1225,                              /* -p */
  OPT_pass_exit_codes = 1226,                /* -pass-exit-codes */
  /* OPT_pedantic = 1227, */                 /* -pedantic */
  OPT_pedantic_errors = 1228,                /* -pedantic-errors */
  OPT_pg = 1229,                             /* -pg */
  OPT_pie = 1230,                            /* -pie */
  OPT_pipe = 1231,                           /* -pipe */
  OPT_posix = 1232,                          /* -posix */
  ...
  OPT_pthread = 1244,                        /* -pthread */
  OPT_quiet = 1245,                          /* -quiet */
  OPT_r = 1246,                              /* -r */
  OPT_rdynamic = 1247,                       /* -rdynamic */
  OPT_remap = 1248,                          /* -remap */
  OPT_rpath_link = 1249,                     /* -rpath-link */
  OPT_rpath_link_ = 1250,                    /* -rpath-link= */
  OPT_rpath_ = 1251,                         /* -rpath= */
  OPT_s = 1252,                              /* -s */
  ...
  OPT_stdlib_libc__ = 1319,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1320,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1321,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1322,               /* -stdlib=libstdc++ */

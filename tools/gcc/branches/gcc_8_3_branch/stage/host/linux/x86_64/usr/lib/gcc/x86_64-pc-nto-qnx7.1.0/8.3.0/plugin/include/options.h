...
enum opt_code
{
  ...
  OPT_Woverflow = 325,                       /* -Woverflow */
  OPT_Woverlength_strings = 326,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 327,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 328,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 329,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 330,                             /* -Wp, */
  OPT_Wpacked = 331,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 332,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 333,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 334,                         /* -Wpadded */
  OPT_Wparentheses = 335,                    /* -Wparentheses */
  OPT_Wpedantic = 336,                       /* -Wpedantic */
  ...
  OPT_m128bit_long_double = 1191,            /* -m128bit-long-double */
  OPT_m16 = 1192,                            /* -m16 */
  OPT_m32 = 1193,                            /* -m32 */
  OPT_m3dnow = 1194,                         /* -m3dnow */
  OPT_m3dnowa = 1195,                        /* -m3dnowa */
  OPT_m64 = 1196,                            /* -m64 */
  OPT_m80387 = 1197,                         /* -m80387 */
  OPT_m8bit_idiv = 1198,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1199,             /* -m96bit-long-double */
  OPT_mabi_ = 1200,                          /* -mabi= */
  OPT_mabm = 1201,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1202,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1203,                 /* -maddress-mode= */
  OPT_madx = 1204,                           /* -madx */
  OPT_maes = 1205,                           /* -maes */
  OPT_malign_data_ = 1206,                   /* -malign-data= */
  OPT_malign_double = 1207,                  /* -malign-double */
  OPT_malign_functions_ = 1208,              /* -malign-functions= */
  OPT_malign_jumps_ = 1209,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1210,                  /* -malign-loops= */
  OPT_malign_stringops = 1211,               /* -malign-stringops */
  OPT_march_ = 1212,                         /* -march= */
  OPT_masm_ = 1213,                          /* -masm= */
  OPT_mavx = 1214,                           /* -mavx */
  OPT_mavx2 = 1215,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1216,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1217,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1218,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1219,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1220,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1221,                      /* -mavx512bw */
  OPT_mavx512cd = 1222,                      /* -mavx512cd */
  OPT_mavx512dq = 1223,                      /* -mavx512dq */
  OPT_mavx512er = 1224,                      /* -mavx512er */
  OPT_mavx512f = 1225,                       /* -mavx512f */
  OPT_mavx512ifma = 1226,                    /* -mavx512ifma */
  OPT_mavx512pf = 1227,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1228,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1229,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1230,                      /* -mavx512vl */
  OPT_mavx512vnni = 1231,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1232,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1233,                           /* -mbmi */
  OPT_mbmi2 = 1234,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1235,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1236,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1237,                    /* -mcet-switch */
  OPT_mcld = 1238,                           /* -mcld */
  OPT_mclflushopt = 1239,                    /* -mclflushopt */
  OPT_mclwb = 1240,                          /* -mclwb */
  OPT_mclzero = 1241,                        /* -mclzero */
  OPT_mcmodel_ = 1242,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1243, */                    /* -mcpu= */
  OPT_mcrc32 = 1244,                         /* -mcrc32 */
  OPT_mcx16 = 1245,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1246,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1247,            /* -mdump-tune-features */
  OPT_mf16c = 1248,                          /* -mf16c */
  OPT_mfancy_math_387 = 1249,                /* -mfancy-math-387 */
  OPT_mfentry = 1250,                        /* -mfentry */
  OPT_mfma = 1251,                           /* -mfma */
  OPT_mfma4 = 1252,                          /* -mfma4 */
  OPT_mforce_drap = 1253,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1254,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1255,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1256,                       /* -mfpmath= */
  OPT_mfsgsbase = 1257,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1258,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1259, */              /* -mfused-madd */
  OPT_mfxsr = 1260,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1261,             /* -mgeneral-regs-only */
  OPT_mgfni = 1262,                          /* -mgfni */
  OPT_mhard_float = 1263,                    /* -mhard-float */
  OPT_mhle = 1264,                           /* -mhle */
  OPT_miamcu = 1265,                         /* -miamcu */
  OPT_mieee_fp = 1266,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1267,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1268,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1269,              /* -mindirect-branch= */
  ...
  OPT_mlarge_data_threshold_ = 1273,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1274,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1275,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1276,                /* -mlong-double-80 */
  OPT_mlwp = 1277,                           /* -mlwp */
  OPT_mlzcnt = 1278,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1279,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1280,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1281,                  /* -mmitigate-rop */
  OPT_mmmx = 1282,                           /* -mmmx */
  OPT_mmovbe = 1283,                         /* -mmovbe */
  OPT_mmovdir64b = 1284,                     /* -mmovdir64b */
  OPT_mmovdiri = 1285,                       /* -mmovdiri */
  OPT_mmpx = 1286,                           /* -mmpx */
  OPT_mms_bitfields = 1287,                  /* -mms-bitfields */
  OPT_mmwaitx = 1288,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1289,            /* -mno-align-stringops */
  OPT_mno_default = 1290,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1291,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1292,                  /* -mno-push-args */
  OPT_mno_red_zone = 1293,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1294,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1295,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1296,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1297,                          /* -mpc32 */
  OPT_mpc64 = 1298,                          /* -mpc64 */
  OPT_mpc80 = 1299,                          /* -mpc80 */
  OPT_mpclmul = 1300,                        /* -mpclmul */
  OPT_mpcommit = 1301,                       /* -mpcommit */
  OPT_mpconfig = 1302,                       /* -mpconfig */
  OPT_mpku = 1303,                           /* -mpku */
  OPT_mpopcnt = 1304,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1305, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1306,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1307,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1308,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1309,                        /* -mprfchw */
  OPT_mpush_args = 1310,                     /* -mpush-args */
  OPT_mrdpid = 1311,                         /* -mrdpid */
  OPT_mrdrnd = 1312,                         /* -mrdrnd */
  OPT_mrdseed = 1313,                        /* -mrdseed */
  OPT_mrecip = 1314,                         /* -mrecip */
  OPT_mrecip_ = 1315,                        /* -mrecip= */
  OPT_mrecord_mcount = 1316,                 /* -mrecord-mcount */
  OPT_mred_zone = 1317,                      /* -mred-zone */
  OPT_mregparm_ = 1318,                      /* -mregparm= */
  OPT_mrtd = 1319,                           /* -mrtd */
  OPT_mrtm = 1320,                           /* -mrtm */
  OPT_msahf = 1321,                          /* -msahf */
  OPT_msgx = 1322,                           /* -msgx */
  OPT_msha = 1323,                           /* -msha */
  OPT_mshstk = 1324,                         /* -mshstk */
  OPT_mskip_rax_setup = 1325,                /* -mskip-rax-setup */
  OPT_msoft_float = 1326,                    /* -msoft-float */
  OPT_msse = 1327,                           /* -msse */
  OPT_msse2 = 1328,                          /* -msse2 */
  OPT_msse2avx = 1329,                       /* -msse2avx */
  OPT_msse3 = 1330,                          /* -msse3 */
  OPT_msse4 = 1331,                          /* -msse4 */
  OPT_msse4_1 = 1332,                        /* -msse4.1 */
  OPT_msse4_2 = 1333,                        /* -msse4.2 */
  OPT_msse4a = 1334,                         /* -msse4a */
  /* OPT_msse5 = 1335, */                    /* -msse5 */
  OPT_msseregparm = 1336,                    /* -msseregparm */
  OPT_mssse3 = 1337,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1338,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1339, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1340,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1341, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1342,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1343,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1344,            /* -mstringop-strategy= */
  OPT_mstv = 1345,                           /* -mstv */
  OPT_mtbm = 1346,                           /* -mtbm */
  OPT_mtls_dialect_ = 1347,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1348,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1349,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1350,                         /* -mtune= */
  OPT_mvaes = 1351,                          /* -mvaes */
  OPT_mveclibabi_ = 1352,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1353,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1354,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1355,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1356,                      /* -mwbnoinvd */
  OPT_mx32 = 1357,                           /* -mx32 */
  OPT_mxop = 1358,                           /* -mxop */
  OPT_mxsave = 1359,                         /* -mxsave */
  OPT_mxsavec = 1360,                        /* -mxsavec */
  OPT_mxsaveopt = 1361,                      /* -mxsaveopt */
  OPT_mxsaves = 1362,                        /* -mxsaves */
  OPT_n = 1363,                              /* -n */
  ...
  /* OPT_nopie = 1369, */                    /* -nopie */
  OPT_nostartfiles = 1370,                   /* -nostartfiles */
  OPT_nostdinc = 1371,                       /* -nostdinc */
  OPT_nostdinc__ = 1372,                     /* -nostdinc++ */
  OPT_nostdlib = 1373,                       /* -nostdlib */
  OPT_o = 1374,                              /* -o */
  OPT_p = 1375,                              /* -p */
  OPT_pass_exit_codes = 1376,                /* -pass-exit-codes */
  /* OPT_pedantic = 1377, */                 /* -pedantic */
  OPT_pedantic_errors = 1378,                /* -pedantic-errors */
  OPT_pg = 1379,                             /* -pg */
  OPT_pie = 1380,                            /* -pie */
  OPT_pipe = 1381,                           /* -pipe */
  OPT_posix = 1382,                          /* -posix */
  OPT_print_file_name_ = 1383,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1384,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1385,          /* -print-multi-directory */
  OPT_print_multi_lib = 1386,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1387,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1388,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1389,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1390,               /* -print-prog-name= */
  OPT_print_search_dirs = 1391,              /* -print-search-dirs */
  OPT_print_sysroot = 1392,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1393,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1394,                        /* -pthread */
  OPT_quiet = 1395,                          /* -quiet */
  OPT_r = 1396,                              /* -r */
  OPT_rdynamic = 1397,                       /* -rdynamic */
  OPT_remap = 1398,                          /* -remap */
  OPT_rpath_link = 1399,                     /* -rpath-link */
  OPT_rpath_link_ = 1400,                    /* -rpath-link= */
  OPT_rpath_ = 1401,                         /* -rpath= */
  OPT_s = 1402,                              /* -s */
  OPT_save_temps = 1403,                     /* -save-temps */
  OPT_save_temps_ = 1404,                    /* -save-temps= */
  OPT_shared = 1405,                         /* -shared */
  OPT_shared_libgcc = 1406,                  /* -shared-libgcc */
  /* OPT_specs = 1407, */                    /* -specs */
  OPT_specs_ = 1408,                         /* -specs= */
  OPT_static = 1409,                         /* -static */
  OPT_static_libasan = 1410,                 /* -static-libasan */
  OPT_static_libgcc = 1411,                  /* -static-libgcc */
  OPT_static_libgfortran = 1412,             /* -static-libgfortran */
  OPT_static_libgo = 1413,                   /* -static-libgo */
  OPT_static_liblsan = 1414,                 /* -static-liblsan */
  OPT_static_libmpx = 1415,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1416,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1417,               /* -static-libstdc++ */
  OPT_static_libtsan = 1418,                 /* -static-libtsan */
  OPT_static_libubsan = 1419,                /* -static-libubsan */
  OPT_static_pie = 1420,                     /* -static-pie */
  /* OPT_std_c__03 = 1421, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1422, */                /* -std=c++0x */
  OPT_std_c__11 = 1423,                      /* -std=c++11 */
  OPT_std_c__14 = 1424,                      /* -std=c++14 */
  OPT_std_c__17 = 1425,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1426, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1427, */                /* -std=c++1z */
  OPT_std_c__2a = 1428,                      /* -std=c++2a */
  OPT_std_c__98 = 1429,                      /* -std=c++98 */
  OPT_std_c11 = 1430,                        /* -std=c11 */
  OPT_std_c17 = 1431,                        /* -std=c17 */
  /* OPT_std_c18 = 1432, */                  /* -std=c18 */
  /* OPT_std_c1x = 1433, */                  /* -std=c1x */
  /* OPT_std_c89 = 1434, */                  /* -std=c89 */
  OPT_std_c90 = 1435,                        /* -std=c90 */
  OPT_std_c99 = 1436,                        /* -std=c99 */
  /* OPT_std_c9x = 1437, */                  /* -std=c9x */
  OPT_std_f2003 = 1438,                      /* -std=f2003 */
  OPT_std_f2008 = 1439,                      /* -std=f2008 */
  OPT_std_f2008ts = 1440,                    /* -std=f2008ts */
  OPT_std_f2018 = 1441,                      /* -std=f2018 */
  OPT_std_f95 = 1442,                        /* -std=f95 */
  OPT_std_gnu = 1443,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1444, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1445, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1446,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1447,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1448,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1449, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1450, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1451,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1452,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1453,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1454,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1455, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1456, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1457, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1458,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1459,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1460, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1461, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1462,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1463, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1464, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1465, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1466, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1467, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1468,                     /* -std=legacy */
  OPT_stdlib_libc__ = 1469,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1470,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1471,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1472,               /* -stdlib=libstdc++ */
  OPT_symbolic = 1473,                       /* -symbolic */
  OPT_t = 1474,                              /* -t */
  OPT_time = 1475,                           /* -time */
  OPT_time_ = 1476,                          /* -time= */
  OPT_traditional = 1477,                    /* -traditional */
  OPT_traditional_cpp = 1478,                /* -traditional-cpp */
  OPT_trigraphs = 1479,                      /* -trigraphs */
  OPT_u = 1480,                              /* -u */
  OPT_undef = 1481,                          /* -undef */
  OPT_v = 1482,                              /* -v */
  OPT_version = 1483,                        /* -version */
  OPT_w = 1484,                              /* -w */
  OPT_wrapper = 1485,                        /* -wrapper */
  OPT_x = 1486,                              /* -x */
  OPT_z = 1487,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

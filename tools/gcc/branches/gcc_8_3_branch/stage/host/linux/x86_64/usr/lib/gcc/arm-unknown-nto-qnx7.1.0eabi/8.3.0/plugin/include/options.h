...
enum opt_code
{
  ...
  /* OPT_Wcatch_value = 192, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 193,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 194,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 195,           /* -Wcharacter-truncation */
  OPT_Wchkp = 196,                           /* -Wchkp */
  OPT_Wclass_memaccess = 197,                /* -Wclass-memaccess */
  OPT_Wclobbered = 198,                      /* -Wclobbered */
  OPT_Wcomment = 199,                        /* -Wcomment */
  /* OPT_Wcomments = 200, */                 /* -Wcomments */
  OPT_Wcompare_reals = 201,                  /* -Wcompare-reals */
  ...
  OPT_Wdangling_else = 209,                  /* -Wdangling-else */
  ...
  OPT_Wdo_subscript = 221,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 222,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 223,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 224,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 225,                /* -Wduplicated-cond */
  OPT_Weffc__ = 226,                         /* -Weffc++ */
  ...
  OPT_Wexpansion_to_defined = 233,           /* -Wexpansion-to-defined */
  OPT_Wextra = 234,                          /* -Wextra */
  OPT_Wextra_semi = 235,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 236,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 237,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 238,                    /* -Wfloat-equal */
  /* OPT_Wformat = 239, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 240,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 241,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 242,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 243, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 244,               /* -Wformat-overflow= */
  OPT_Wformat_security = 245,                /* -Wformat-security */
  OPT_Wformat_signedness = 246,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 247, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 248,             /* -Wformat-truncation= */
  ...
  OPT_Wfrontend_loop_interchange = 255,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 256,           /* -Wfunction-elimination */
  OPT_Whsa = 257,                            /* -Whsa */
  OPT_Wif_not_aligned = 258,                 /* -Wif-not-aligned */
  ...
  /* OPT_Wimplicit_fallthrough = 262, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 263,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 264,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 265,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 266,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 267,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 268, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 269,     /* -Wincompatible-pointer-types */
  ...
  OPT_Wint_in_bool_context = 274,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 275,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 276,               /* -Winteger-division */
  ...
  OPT_Wmultistatement_macros = 309,          /* -Wmultistatement-macros */
  ...
  OPT_Wnoexcept_type = 314,                  /* -Wnoexcept-type */
  ...
  OPT_Wpacked_not_aligned = 335,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 336,                         /* -Wpadded */
  OPT_Wparentheses = 337,                    /* -Wparentheses */
  OPT_Wpedantic = 338,                       /* -Wpedantic */
  /* OPT_Wplacement_new = 339, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 340,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 341,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 342,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 343,                /* -Wpointer-compare */
  ...
  OPT_Wregister = 354,                       /* -Wregister */
  OPT_Wreorder = 355,                        /* -Wreorder */
  OPT_Wrestrict = 356,                       /* -Wrestrict */
  ...
  OPT_Wshadow_compatible_local = 366,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 367, */            /* -Wshadow=global */
  OPT_Wshadow_local = 368,                   /* -Wshadow=local */
  ...
  OPT_Wsizeof_pointer_div = 379,             /* -Wsizeof-pointer-div */
  ...
  /* OPT_Wstringop_overflow = 390, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 391,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 392,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 393,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 394,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 395,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 396,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 397,       /* -Wsuggest-attribute=malloc */
  ...
  OPT_Wswitch_unreachable = 408,             /* -Wswitch-unreachable */
  ...
  OPT_Wundefined_do_loop = 424,              /* -Wundefined-do-loop */
  ...
  OPT_Wunused_but_set_parameter = 432,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 433,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 434, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 435,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 436,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 437,                /* -Wunused-function */
  OPT_Wunused_label = 438,                   /* -Wunused-label */
  ...
  OPT_Wunused_value = 443,                   /* -Wunused-value */
  OPT_Wunused_variable = 444,                /* -Wunused-variable */
  OPT_Wuse_without_only = 445,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 446,                   /* -Wuseless-cast */
  OPT_Wvarargs = 447,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 448,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 449,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 450,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 451,            /* -Wvirtual-move-assign */
  OPT_Wvla = 452,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 453,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 454,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 455,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 456,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 457,                       /* -Wzerotrip */
  OPT_Xassembler = 458,                      /* -Xassembler */
  OPT_Xlinker = 459,                         /* -Xlinker */
  OPT_Xpreprocessor = 460,                   /* -Xpreprocessor */
  OPT_Z = 461,                               /* -Z */
  OPT_ansi = 462,                            /* -ansi */
  OPT_aux_info = 463,                        /* -aux-info */
  /* OPT_aux_info_ = 464, */                 /* -aux-info= */
  OPT_auxbase = 465,                         /* -auxbase */
  OPT_auxbase_strip = 466,                   /* -auxbase-strip */
  OPT_c = 467,                               /* -c */
  OPT_coverage = 468,                        /* -coverage */
  OPT_cpp = 469,                             /* -cpp */
  OPT_cpp_ = 470,                            /* -cpp= */
  OPT_d = 471,                               /* -d */
  OPT_dumpbase = 472,                        /* -dumpbase */
  OPT_dumpdir = 473,                         /* -dumpdir */
  OPT_dumpfullversion = 474,                 /* -dumpfullversion */
  OPT_dumpmachine = 475,                     /* -dumpmachine */
  OPT_dumpspecs = 476,                       /* -dumpspecs */
  OPT_dumpversion = 477,                     /* -dumpversion */
  OPT_e = 478,                               /* -e */
  OPT_export_dynamic = 479,                  /* -export-dynamic */
  OPT_fPIC = 480,                            /* -fPIC */
  OPT_fPIE = 481,                            /* -fPIE */
  OPT_fRTS_ = 482,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 483,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 484,                   /* -fabi-version= */
  OPT_faccess_control = 485,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 486,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 487,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 488,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 489,                  /* -falign-commons */
  OPT_falign_functions = 490,                /* -falign-functions */
  OPT_falign_functions_ = 491,               /* -falign-functions= */
  OPT_falign_jumps = 492,                    /* -falign-jumps */
  OPT_falign_jumps_ = 493,                   /* -falign-jumps= */
  OPT_falign_labels = 494,                   /* -falign-labels */
  OPT_falign_labels_ = 495,                  /* -falign-labels= */
  OPT_falign_loops = 496,                    /* -falign-loops */
  OPT_falign_loops_ = 497,                   /* -falign-loops= */
  /* OPT_faligned_new = 498, */              /* -faligned-new */
  OPT_faligned_new_ = 499,                   /* -faligned-new= */
  OPT_fall_intrinsics = 500,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 501, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 502,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 503,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 504, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 505, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 506, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 507, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 508, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 509,            /* -fasan-shadow-offset= */
  OPT_fasm = 510,                            /* -fasm */
  OPT_fassociative_math = 511,               /* -fassociative-math */
  ...
  OPT_fbackslash = 517,                      /* -fbackslash */
  OPT_fbacktrace = 518,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 519,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 520,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 521,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 522,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 523,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 524,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 525,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 526,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 527,                        /* -fbuiltin */
  OPT_fbuiltin_ = 528,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 529,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 530,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 531,                    /* -fcall-saved- */
  OPT_fcall_used_ = 532,                     /* -fcall-used- */
  OPT_fcaller_saves = 533,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 534,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 535, */            /* -fcf-protection */
  OPT_fcf_protection_ = 536,                 /* -fcf-protection= */
  OPT_fcheck_array_temporaries = 537,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 538,                /* -fcheck-data-deps */
  OPT_fcheck_new = 539,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 540,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 541,                         /* -fcheck= */
  OPT_fchecking = 542,                       /* -fchecking */
  OPT_fchecking_ = 543,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 544,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 545,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 546,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 547,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 548,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 549,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 550,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 551,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 552, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 553,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 554,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 555,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 556, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 557,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 558,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 559,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 560,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 561,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 562,                       /* -fcilkplus */
  OPT_fcoarray_ = 563,                       /* -fcoarray= */
  OPT_fcode_hoisting = 564,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 565,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 566,                         /* -fcommon */
  OPT_fcompare_debug = 567,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 568,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 569,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 570,                   /* -fcompare-elim */
  OPT_fconcepts = 571,                       /* -fconcepts */
  OPT_fcond_mismatch = 572,                  /* -fcond-mismatch */
  OPT_fconserve_space = 573,                 /* -fconserve-space */
  OPT_fconserve_stack = 574,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 575,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 576,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 577,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 578,                       /* -fconvert= */
  OPT_fcprop_registers = 579,                /* -fcprop-registers */
  OPT_fcray_pointer = 580,                   /* -fcray-pointer */
  OPT_fcrossjumping = 581,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 582,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 583, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 584,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 585,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 586,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 587,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 588,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 589,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 590,                       /* -fdbg-cnt= */
  OPT_fdce = 591,                            /* -fdce */
  OPT_fdebug_cpp = 592,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 593,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 594,            /* -fdebug-types-section */
  OPT_fdec = 595,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 596,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 597,                       /* -fdec-math */
  OPT_fdec_static = 598,                     /* -fdec-static */
  OPT_fdec_structure = 599,                  /* -fdec-structure */
  ...
  OPT_fdefault_real_10 = 605,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 606,                /* -fdefault-real-16 */
  ...
  OPT_fdiagnostics_generate_patch = 617,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 618,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 619,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 620,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 621,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 622, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 623,                /* -fdirectives-only */
  OPT_fdisable_ = 624,                       /* -fdisable- */
  ...
  OPT_felide_type = 646,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 647, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 648, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 649,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 650,        /* -femit-class-debug-always */
  ...
  OPT_fenforce_eh_specs = 655,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 656, */           /* -fenum-int-equiv */
  OPT_fexceptions = 657,                     /* -fexceptions */
  OPT_fexcess_precision_ = 658,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 659,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 660,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 661,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 662,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 663,                /* -fextern-tls-init */
  OPT_fexternal_blas = 664,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 665, */       /* -fexternal-templates */
  OPT_ff2c = 666,                            /* -ff2c */
  OPT_ffast_math = 667,                      /* -ffast-math */
  OPT_ffat_lto_objects = 668,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 669,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 670,               /* -ffinite-math-only */
  OPT_ffixed_ = 671,                         /* -ffixed- */
  OPT_ffixed_form = 672,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 673,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 674,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 675,                    /* -ffloat-store */
  OPT_ffor_scope = 676,                      /* -ffor-scope */
  /* OPT_fforce_addr = 677, */               /* -fforce-addr */
  OPT_fforward_propagate = 678,              /* -fforward-propagate */
  OPT_ffp_contract_ = 679,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 680,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 681,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 682,                      /* -ffpe-trap= */
  OPT_ffree_form = 683,                      /* -ffree-form */
  OPT_ffree_line_length_ = 684,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 685,          /* -ffree-line-length-none */
  OPT_ffreestanding = 686,                   /* -ffreestanding */
  OPT_ffriend_injection = 687,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 688,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 689,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 690,                   /* -ffunction-cse */
  OPT_ffunction_sections = 691,              /* -ffunction-sections */
  OPT_fgcse = 692,                           /* -fgcse */
  OPT_fgcse_after_reload = 693,              /* -fgcse-after-reload */
  OPT_fgcse_las = 694,                       /* -fgcse-las */
  OPT_fgcse_lm = 695,                        /* -fgcse-lm */
  OPT_fgcse_sm = 696,                        /* -fgcse-sm */
  OPT_fgimple = 697,                         /* -fgimple */
  OPT_fgnat_encodings_ = 698,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 699,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 700,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 701,                         /* -fgnu-tm */
  OPT_fgnu_unique = 702,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 703,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 704,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 705,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 706,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 707,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 708,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 709,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 710,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 711,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 712,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 713,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 714,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 715,                       /* -fgraphite */
  OPT_fgraphite_identity = 716,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 717,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 718, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 719, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 720, */                     /* -fhelp */
  ...
  OPT_finit_derived = 736,                   /* -finit-derived */
  OPT_finit_integer_ = 737,                  /* -finit-integer= */
  OPT_finit_local_zero = 738,                /* -finit-local-zero */
  OPT_finit_logical_ = 739,                  /* -finit-logical= */
  OPT_finit_real_ = 740,                     /* -finit-real= */
  OPT_finline = 741,                         /* -finline */
  OPT_finline_atomics = 742,                 /* -finline-atomics */
  OPT_finline_functions = 743,               /* -finline-functions */
  OPT_finline_functions_called_once = 744,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 745, */            /* -finline-limit- */
  OPT_finline_limit_ = 746,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 747,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 748,         /* -finline-small-functions */
  OPT_finput_charset_ = 749,                 /* -finput-charset= */
  OPT_finstrument_functions = 750,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 751,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 752,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 753,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 754,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 755,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 756,                     /* -fipa-bit-cp */
  ...
  OPT_fipa_vrp = 771,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 772,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 773,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 774,              /* -fira-loop-pressure */
  OPT_fira_region_ = 775,                    /* -fira-region= */
  OPT_fira_share_save_slots = 776,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 777,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 778,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 779,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 780,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 781,               /* -fivar-visibility= */
  OPT_fivopts = 782,                         /* -fivopts */
  ...
  OPT_flifetime_dse_ = 793,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 794,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 795,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 796,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 797,                    /* -flocal-ivars */
  /* OPT_floop_block = 798, */               /* -floop-block */
  /* OPT_floop_flatten = 799, */             /* -floop-flatten */
  OPT_floop_interchange = 800,               /* -floop-interchange */
  OPT_floop_nest_optimize = 801,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 802, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 803,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 804, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 805,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 806,                      /* -flra-remat */
  OPT_flto = 807,                            /* -flto */
  OPT_flto_compression_level_ = 808,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 809,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 810,                 /* -flto-partition= */
  OPT_flto_report = 811,                     /* -flto-report */
  OPT_flto_report_wpa = 812,                 /* -flto-report-wpa */
  OPT_flto_ = 813,                           /* -flto= */
  OPT_fltrans = 814,                         /* -fltrans */
  OPT_fltrans_output_list_ = 815,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 816,              /* -fmacro-prefix-map= */
  OPT_fmath_errno = 817,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 818,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 819,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 820,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 821,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 822,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 823,                     /* -fmem-report */
  OPT_fmem_report_wpa = 824,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 825,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 826,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 827,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 828,                /* -fmessage-length= */
  OPT_fmodule_private = 829,                 /* -fmodule-private */
  OPT_fmodulo_sched = 830,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 831,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 832,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 833,                  /* -fms-extensions */
  /* OPT_fmudflap = 834, */                  /* -fmudflap */
  /* OPT_fmudflapir = 835, */                /* -fmudflapir */
  /* OPT_fmudflapth = 836, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 837, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 838, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 839,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 840,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 841,                   /* -fnext-runtime */
  OPT_fnil_receivers = 842,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 843,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 844,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 845, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 846,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 847,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 848,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 849,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 850,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 851,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 852,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 853,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 854,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 855,                   /* -foffload-abi= */
  OPT_foffload_ = 856,                       /* -foffload= */
  OPT_fomit_frame_pointer = 857,             /* -fomit-frame-pointer */
  OPT_fopenacc = 858,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 859,                   /* -fopenacc-dim= */
  OPT_fopenmp = 860,                         /* -fopenmp */
  OPT_fopenmp_simd = 861,                    /* -fopenmp-simd */
  OPT_foperator_names = 862,                 /* -foperator-names */
  OPT_fopt_info = 863,                       /* -fopt-info */
  OPT_fopt_info_ = 864,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 865, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 866,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 867,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 868, */           /* -foptional-diags */
  OPT_fpack_derived = 869,                   /* -fpack-derived */
  OPT_fpack_struct = 870,                    /* -fpack-struct */
  OPT_fpack_struct_ = 871,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 872,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 873,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 874,              /* -fpcc-struct-return */
  OPT_fpch_deps = 875,                       /* -fpch-deps */
  OPT_fpch_preprocess = 876,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 877,                     /* -fpeel-loops */
  OPT_fpeephole = 878,                       /* -fpeephole */
  OPT_fpeephole2 = 879,                      /* -fpeephole2 */
  OPT_fpermissive = 880,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 881,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 882,                            /* -fpic */
  OPT_fpie = 883,                            /* -fpie */
  OPT_fplan9_extensions = 884,               /* -fplan9-extensions */
  OPT_fplt = 885,                            /* -fplt */
  OPT_fplugin_arg_ = 886,                    /* -fplugin-arg- */
  OPT_fplugin_ = 887,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 888,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 889,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 890,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 891,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 892,                   /* -fpreprocessed */
  OPT_fpretty_templates = 893,               /* -fpretty-templates */
  OPT_fprintf_return_value = 894,            /* -fprintf-return-value */
  OPT_fprofile = 895,                        /* -fprofile */
  OPT_fprofile_abs_path = 896,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 897,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 898,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 899,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 900,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 901,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 902,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 903,                 /* -fprofile-report */
  OPT_fprofile_update_ = 904,                /* -fprofile-update= */
  ...
  OPT_free = 924,                            /* -free */
  OPT_freg_struct_return = 925,              /* -freg-struct-return */
  /* OPT_fregmove = 926, */                  /* -fregmove */
  OPT_frename_registers = 927,               /* -frename-registers */
  OPT_freorder_blocks = 928,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 929,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 930,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 931,              /* -freorder-functions */
  OPT_frepack_arrays = 932,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 933,           /* -freplace-objc-classes */
  OPT_frepo = 934,                           /* -frepo */
  OPT_freport_bug = 935,                     /* -freport-bug */
  OPT_frequire_return_statement = 936,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 937,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 938, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 939,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 940,                    /* -fresolution= */
  OPT_frounding_math = 941,                  /* -frounding-math */
  OPT_frtti = 942,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 943,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 944,             /* -fsanitize-coverage= */
  ...
  OPT_fsched_critical_path_heuristic = 950,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 951,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 952,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 953,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 954,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 955,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 956,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 957,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 958,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 959,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 960,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 961,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 962,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 963,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 964,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 965,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 966,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 967, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 968,                /* -fschedule-fusion */
  OPT_fschedule_insns = 969,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 970,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 971,              /* -fsecond-underscore */
  OPT_fsection_anchors = 972,                /* -fsection-anchors */
  /* OPT_fsee = 973, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 974,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 975,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 976, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 977,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 978,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 979,                     /* -fself-test= */
  ...
  OPT_fshrink_wrap_separate = 985,           /* -fshrink-wrap-separate */
  ...
  OPT_fsplit_ivs_in_unroller = 994,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 995,                    /* -fsplit-loops */
  ...
  OPT_fstack_clash_protection = 1006,        /* -fstack-clash-protection */
  ...
  OPT_fstore_merging = 1018,                 /* -fstore-merging */
  ...
  /* OPT_fstrong_eval_order = 1025, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1026,            /* -fstrong-eval-order= */
  ...
  OPT_ftest_forall_temp = 1035,              /* -ftest-forall-temp */
  ...
  OPT_ftime_report_details = 1040,           /* -ftime-report-details */
  OPT_ftls_model_ = 1041,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1042,              /* -ftoplevel-reorder */
  OPT_ftracer = 1043,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1044,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1045,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1046,                   /* -ftrampolines */
  ...
  OPT_fwrapv_pointer = 1137,                 /* -fwrapv-pointer */
  ...
  OPT_mabi_ = 1193,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1194,             /* -mabort-on-noreturn */
  OPT_mapcs = 1195,                          /* -mapcs */
  OPT_mapcs_frame = 1196,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1197,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1198,              /* -mapcs-stack-check */
  OPT_march_ = 1199,                         /* -march= */
  OPT_marm = 1200,                           /* -marm */
  OPT_masm_syntax_unified = 1201,            /* -masm-syntax-unified */
  OPT_mbe32 = 1202,                          /* -mbe32 */
  OPT_mbe8 = 1203,                           /* -mbe8 */
  ...
  OPT_mneon_for_64bits = 1218,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1219,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1220,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1221,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1222,               /* -mprint-tune-info */
  OPT_mpure_code = 1223,                     /* -mpure-code */
  OPT_mrestrict_it = 1224,                   /* -mrestrict-it */
  OPT_msched_prolog = 1225,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1226,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1227,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1228, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1229,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1230,                         /* -mthumb */
  OPT_mthumb_interwork = 1231,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1232,                  /* -mtls-dialect= */
  OPT_mtp_ = 1233,                           /* -mtp= */
  OPT_mtpcs_frame = 1234,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1235,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1236,                         /* -mtune= */
  OPT_munaligned_access = 1237,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1238,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1239,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1240,             /* -mverbose-cost-dump */
  ...
  OPT_pthread = 1273,                        /* -pthread */
  OPT_quiet = 1274,                          /* -quiet */
  OPT_r = 1275,                              /* -r */
  OPT_rdynamic = 1276,                       /* -rdynamic */
  OPT_remap = 1277,                          /* -remap */
  OPT_rpath_link = 1278,                     /* -rpath-link */
  OPT_rpath_link_ = 1279,                    /* -rpath-link= */
  OPT_rpath_ = 1280,                         /* -rpath= */
  OPT_s = 1281,                              /* -s */
  ...
  OPT_stdlib_libc__ = 1348,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1349,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1350,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1351,               /* -stdlib=libstdc++ */

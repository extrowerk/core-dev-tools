...
#define HAVE_nospeculateqi 1
#define HAVE_nospeculatehi 1
#define HAVE_nospeculatesi 1
#define HAVE_nospeculatedi 1
#define HAVE_nospeculateti 1
...
extern rtx        gen_nospeculateti                       (rtx, rtx, rtx, rtx, rtx);

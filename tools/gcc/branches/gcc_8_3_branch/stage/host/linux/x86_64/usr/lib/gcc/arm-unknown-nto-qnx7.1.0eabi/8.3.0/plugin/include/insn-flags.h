...
#define HAVE_nop 1
#define HAVE_trap 1
#define HAVE_cmp_ior (TARGET_32BIT)
...
#define HAVE_nospeculateqi (TARGET_32BIT)
#define HAVE_nospeculatehi (TARGET_32BIT)
#define HAVE_nospeculatesi (TARGET_32BIT)
#define HAVE_nospeculatedi (TARGET_32BIT)
...
extern rtx        gen_cmp_ior                           (rtx, rtx, rtx, rtx, rtx, rtx, rtx);
...
extern rtx        gen_nospeculateqi                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_nospeculatehi                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_nospeculatesi                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_nospeculatedi                     (rtx, rtx, rtx, rtx, rtx);

     ...
     int mode;
{
  ...
  if (! strcmp(name, "as")) {
    ...
    if ((!IS_ABSOLUTE_PATH (DEFAULT_ASSEMBLER)) && (strcmp (DEFAULT_ASSEMBLER, name)))
      return (find_a_file (pprefix, DEFAULT_ASSEMBLER, mode));
  }
#endif
  ...
  if (! strcmp(name, "ld")) {
    ...
    if ((!IS_ABSOLUTE_PATH (DEFAULT_LINKER)) && (strcmp (DEFAULT_LINKER, name)))
      return (find_a_file (pprefix, DEFAULT_LINKER, mode));
  }
#endif

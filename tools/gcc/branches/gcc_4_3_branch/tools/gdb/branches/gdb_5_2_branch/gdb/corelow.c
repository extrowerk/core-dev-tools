...
extern void fetch_core_registers PARAMS((char *, unsigned, int, CORE_ADDR));
...
#ifdef __CYGWIN__
static void real_core_open (char *, int);
...
core_open (char *filename, int from_tty)
{
  ...
  real_core_open(buf, from_tty);
}

static void
real_core_open (char *filename, int from_tty)
#else
static void
core_open (char *filename, int from_tty)
#endif

...
struct mips_opcode
{
  ...
  /* A collection of bits describing a particular instruction is not
     allowed in an architecture. */
  unsigned long disable_insn; 
...
/* Toshiba R7900 instruction */
#define INSN_7900                   0x00008000
...
#define CPU_R5400	5400
#define CPU_R5900	5900
#define CPU_R6000	6000
#define CPU_R7900	7900
...
#define OPCODE_IS_MEMBER(insn, isa, cpu)				\
    (((insn)->membership & isa) != 0					\
     ...
     || (cpu == CPU_R7900 && ((insn)->disable_insn & INSN_7900) != INSN_7900	\
         && ((insn)->membership & INSN_7900) != 0)			\
     || (cpu == CPU_R5400 && ((insn)->membership & INSN_5400) != 0)		\

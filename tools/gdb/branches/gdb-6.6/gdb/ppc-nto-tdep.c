...
static CORE_ADDR
ppc_nto_skip_trampoline_code (CORE_ADDR pc)
{
  char buf[4];
...
ppcnto_svr4_fetch_link_map_offsets (void)
{
...
init_ppcnto_ops ()
{
  ...
  nto_fetch_link_map_offsets = ppcnto_svr4_fetch_link_map_offsets;
}
...
ppcnto_init_abi (struct gdbarch_info info, struct gdbarch *gdbarch)
{
  ...
  set_solib_svr4_fetch_link_map_offsets (gdbarch,
					 ppcnto_svr4_fetch_link_map_offsets);

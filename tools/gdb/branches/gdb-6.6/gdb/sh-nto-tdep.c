...
shnto_svr4_fetch_link_map_offsets (void)
{
...
init_shnto_ops ()
{
  ...
  nto_fetch_link_map_offsets = shnto_svr4_fetch_link_map_offsets;
}
...
shnto_init_abi (struct gdbarch_info info, struct gdbarch *gdbarch)
{
  ...
  set_solib_svr4_fetch_link_map_offsets (gdbarch,
					 shnto_svr4_fetch_link_map_offsets);

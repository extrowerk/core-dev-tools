...
#define _DEBUG_RUN_CHILD			0x00000800	/* Deliver event when process does exec, spawn or fork. */
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/trunk/services/system/public/sys/debug.h $ $Rev: 583009 $" )
